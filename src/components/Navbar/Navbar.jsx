    ...
    <div className=' justify-around flex pb-4'>
      ...
      <div className=''>
        <ul className=' flex gap-1 mt-8 p-1 text-slate-400 cursor-pointer'>
            ...
            <Link to='/Cart'><li className='rounded-md border p-2  ml-4 hover:bg-white hover:text-slate-800 text-xl flex'><TiShoppingCart/><p className='-mt-1 ml-1'>{totalCount}</p></li></Link>
