  ...
  return (
    <div className='flex justify-around h-[99vh] hero'>
      <div className='pb-8'>
        ...
        <Link to='/product'><button className='flex mt-8 p-4 font-semibold bg-red-500 text-emerald-200 rounded-3xl text-xl '>know more <img className='ml-8 m-2' src={arrow} alt="" /></button></Link>
      </div>
      <div className='p-8'>
